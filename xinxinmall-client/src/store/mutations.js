import { ADD_COUNTER,  ADD_TO_CART, INCREASE, DECREASE, CHECKED_ALL, CHANGE_CHECKED, SET_IS_AUTNENTICATED, SET_USER} from './mutation-types'
...
const mutations = {
  ...
  [SET_IS_AUTNENTICATED](state, isAutnenticated) {
    if(isAutnenticated) {
